...
def _is_artifact_only_question(question: str) -> bool:
    ...
    artifact_keywords = [
        "summarize", "summary", "key findings", "key points",
        "main points", "conclusion", "conclusions",
        "what does the report say", "what did you find",
        "explain the", "tell me about the report",
        "recap", "overview", "highlights", "takeaways"
    ]
