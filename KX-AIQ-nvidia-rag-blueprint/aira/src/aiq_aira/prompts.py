...
def build_data_sources_section(use_kdb: bool = False, use_rag: bool = True, use_web: bool = False, hybrid_mode: bool = True) -> str:
    """
    ...
    if use_kdb:
        sources.append("- **KDB+ Financial Database**: Market data, stock prices, trades, time-series, financial metrics, portfolio analytics")
