...
AIQ-KX extends the AI-Q Research Assistant with KDB-X time-series database integration for real-time financial data queries.
...
For full KDB-X deployment instructions, see the [AIQ-KX Deployment Guide](../aiq-kx-deployment-guide.md).
