...
```bash
# Deploy AIQ-KX with pre-built images (no KDB license required for external MCP)
...
For full KDB-X deployment instructions including internal database setup, see the [AIQ-KX Deployment Guide](../aiq-kx-deployment-guide.md).
