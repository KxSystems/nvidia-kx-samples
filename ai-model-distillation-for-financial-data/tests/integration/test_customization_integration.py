...
def load_customization_test_data():
    ...
    insert_log_records(db, tc_records, "test-tool_calling-customization", "test-client-tool_calling-customization")
    ...
    insert_log_records(db, generic_records, "test-generic-customization", "test-client-generic-customization")

    yield

    try:
        db.flywheel_logs.delete_many({"client_id": "test-client-tool_calling-customization", "workload_id": "test-tool_calling-customization"})
        db.flywheel_logs.delete_many({"client_id": "test-client-generic-customization", "workload_id": "test-generic-customization"})
