...
def load_llm_judge_test_data():
    ...
    insert_log_records(db, tc_records, "test-tool_calling-llm-judge", "test-client-tool_calling-llm-judge")
    ...
    insert_log_records(db, generic_records, "test-generic-llm-judge", "test-client-generic-llm-judge")

    yield

    try:
        db.flywheel_logs.delete_many({"client_id": "test-client-tool_calling-llm-judge", "workload_id": "test-tool_calling-llm-judge"})
        db.flywheel_logs.delete_many({"client_id": "test-client-generic-llm-judge", "workload_id": "test-generic-llm-judge"})
