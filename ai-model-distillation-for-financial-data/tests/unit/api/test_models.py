...
class TestEnums:
    ...
    def test_eval_type_values(self):
        ...
        assert EvalType.BACKTEST == "backtest-eval"

        # Test values() class method
        expected_values = {"base-eval", "customized-eval", "backtest-eval"}
    ...
    def test_workload_classification_values(self):
        ...
        assert WorkloadClassification.CLASSIFICATION == "classification"
        assert WorkloadClassification.GENERIC == "classification"
...
class TestTaskResult:
    ...
    def test_get_evaluation_existing(self):
        ...
        task_result.add_evaluation(EvalType.BASE, eval_result)
        retrieved = task_result.get_evaluation(EvalType.BASE)
