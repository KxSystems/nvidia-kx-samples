...
- **Integration:** Connects to KDB-X (for metadata, logging, and vector search) and Redis (for task queueing).
...
- **Monitoring:** Optionally runs Flower for Celery task monitoring.
