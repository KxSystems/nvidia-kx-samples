...
class EvalType(str, Enum):
    ...
    def __str__(self) -> str:
        """String representation for easy KDB-X storage."""
        return self.value
...
class NIMEvaluation(BaseModel):
    ...
    def to_mongo(self) -> dict[str, Any]:
        """Convert NIMEvaluation model to KDB-X record."""
        return {
            "_id": self.id,
            "nim_id": self.nim_id,
    ...
    def from_mongo(cls, doc: dict[str, Any]) -> "NIMEvaluation":
        """Create NIMEvaluation from KDB-X record."""
        return cls(
            _id=doc["_id"],
            nim_id=doc["nim_id"],
...
class NIMCustomization(BaseModel):
    ...
    def to_mongo(self) -> dict:
        """Convert NIMCustomization model to KDB-X record."""
        return self.model_dump(by_alias=True)

    @classmethod
    def from_mongo(cls, data: dict) -> "NIMCustomization":
        """Create NIMCustomization from KDB-X record."""
        if not data:
            return None
        return cls(**data)
...
class NIMRun(BaseModel):
    ...
    def to_mongo(self) -> dict:
        """Convert NIMRun model to KDB-X record."""
        return self.model_dump(by_alias=True)

    @classmethod
    def from_mongo(cls, data: dict) -> "NIMRun":
        """Create NIMRun from KDB-X record."""
        if not data:
            return None
        return cls(**data)
...
class LLMJudgeRun(BaseModel):
    ...
    def to_mongo(self) -> dict:
        """Convert LLMJudgeRun model to KDB-X record."""
        return self.model_dump(by_alias=True)

    @classmethod
    def from_mongo(cls, data: dict) -> "NIMRun":
        """Create LLMJudgeRun from KDB-X record."""
        if not data:
            return None
        return cls(**data)
...
class FlywheelRun(BaseModel):
    ...
    def to_mongo(self) -> dict:
        """Convert FlywheelRun model to KDB-X record."""
        return self.model_dump(by_alias=True)

    @classmethod
    def from_mongo(cls, data: dict) -> "FlywheelRun":
        """Create FlywheelRun from KDB-X record."""
        if not data:
            return None
        return cls(**data)
