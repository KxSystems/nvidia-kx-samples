...
- Vector Database and Retrieval
    ...
    - [KDB.AI Deployment Guide](change-vectordb-kdbai.md)
    - [KDB-X Deployment Guide](change-vectordb-kdbx.md)
    - [Hybrid Search](hybrid_search.md)
    - [Query Decomposition](query_decomposition.md)
    <!-- KDB.AI-only fork: change-vectordb.md and milvus-configuration.md
         describe the upstream multi-VDB support which has been removed from
         this chart. Python implementations remain under src/nvidia_rag/utils/vdb/. -->
