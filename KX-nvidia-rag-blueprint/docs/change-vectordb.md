...
> [!TIP]
> For KDB.AI configuration, see [Configure KDB.AI as Your Vector Database](change-vectordb-kdbai.md).
...
5. After the Helm deployment, port-forward the RAG UI service:
