...
The AI Trader Agents builds off of the NVIDIA RAG Blueprint, allowing users to upload multi-modal PDFs and then create detailed research reports. The **AIQ-KX** edition adds KDB-X financial data integration for time-series analysis.
...
![Select Data Sources](../docs/images/kxta-screen-1.png)
...
![Report Topic and Structure](../docs/images/kxta-screen-2.png)
...
![AI Thinking Process](../docs/images/kxta-screen-3.png)
...
![Research Plan Complete](../docs/images/kxta-screen-4.png)
...
![Report Generation with Agent Activity](../docs/images/kxta-screen-5.png)
...
![Q&A Session](../docs/images/kxta-screen-6.png)
...
![KDB-X Data Loader](../docs/images/kxta-screen-7.png)
...
![KDB Chat Interface](../docs/images/kxta-screen-8.png)
