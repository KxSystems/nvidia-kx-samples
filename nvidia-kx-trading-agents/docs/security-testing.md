...
| **Helm/Kubernetes** | `http://kxta.namespace.svc.cluster.local:8000` |
...
- **Fallback**: If config file is not found or has errors, default patterns in `kxta/src/kxta/schema.py` are used
