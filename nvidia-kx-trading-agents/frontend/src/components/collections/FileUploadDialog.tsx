      ...
      <div className="bg-nvidia-gray-800 rounded-xl border border-nvidia-gray-700 w-full max-w-lg shadow-2xl animate-fade-in">
        <div className="flex items-center justify-between p-4 border-b border-nvidia-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-nvidia-gray-50">Upload Documents</h3>
          ...
          <button
            ...
            className="p-1 text-nvidia-gray-400 hover:text-nvidia-gray-50 transition-colors disabled:opacity-50"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm text-nvidia-gray-50 truncate">{file.name}</p>
                  ...
                  <button
                    ...
                    disabled={isUploading}
                    className="p-1 text-nvidia-gray-400 hover:text-red-600 transition-colors disabled:opacity-50"
                  >
