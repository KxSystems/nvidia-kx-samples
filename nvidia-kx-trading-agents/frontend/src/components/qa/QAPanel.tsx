...
export function QAPanel({ onBack }: QAPanelProps) {
  ...
  // Auto-scroll ONLY the message container (never the page), and only when the
  // user is already near the bottom. scrollIntoView() would scroll every
  // scrollable ancestor — including the window — which yanked the page down
  // even when the chat was short and didn't overflow.
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <Card className="flex-1 flex flex-col min-h-0">
        <div ref={messagesContainerRef} className="flex-1 overflow-y-auto space-y-4 mb-4 scrollbar-thin">
