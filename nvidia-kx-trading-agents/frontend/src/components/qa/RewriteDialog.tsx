  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div
        ...
        className="bg-nvidia-gray-800 rounded-xl border border-nvidia-gray-700 w-full max-w-lg shadow-2xl animate-fade-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between p-4 border-b border-nvidia-gray-700">
          <h3 id="rewrite-dialog-title" className="text-lg font-semibold text-nvidia-gray-50">Rewrite Report</h3>
          <button
            onClick={onClose}
