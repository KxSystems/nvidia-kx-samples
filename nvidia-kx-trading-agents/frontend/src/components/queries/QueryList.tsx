...
interface QueryListProps {
  onExecutePlan: () => void;
  /** Disable execution (e.g. no agents enabled) — the page shows why. */
  executeDisabled?: boolean;
}

export function QueryList({ onExecutePlan, executeDisabled = false }: QueryListProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-end pt-4">
        <Button
          ...
          disabled={queries.length === 0 || isStreaming || !planReady || executeDisabled}
