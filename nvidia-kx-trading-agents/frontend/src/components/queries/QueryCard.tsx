  ...
  return (
    <Card padding="sm" className="animate-fade-in">
      ...
      <div
        ...
        aria-label={`Query ${index + 1}: ${query.query}`}
        className={clsx(
          'flex items-center gap-3 cursor-pointer rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-nvidia-green',
