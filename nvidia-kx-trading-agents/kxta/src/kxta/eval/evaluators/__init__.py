...
"""
NVIDIA Trading Agents Blueprint Evaluator - Evaluation framework for NVIDIA Trading Agents Blueprint workflows

This package provides evaluation capabilities for the NVIDIA Trading Agents Blueprint
following the patterns established in the SWE bench evaluation framework.
"""
# Evaluators for NVIDIA Trading Agents Blueprint workflow
