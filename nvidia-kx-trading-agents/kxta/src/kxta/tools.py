...
from kxta.constants import ASYNC_TIMEOUT, RAG_API_KEY, TAVILY_INCLUDE_DOMAINS
from langgraph.types import StreamWriter
from kxta.utils import get_domain
...
async def search_rag(
    ...
    Returns a tuple (content, citations, doc_count).
    """
...
"""
                return (content, citations, doc_count)
...
"""
        ...
        return (f"Timeout fetching {req_url}:", "", 0)
...
"""
        ...
        return (f"Error fetching {req_url}: {e}", "", 0)
