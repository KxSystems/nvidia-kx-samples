...
from kxta.schema import GenerateSummaryStateInput, GenerateSummaryStateOutput, GeneratedQuery
...
#   RUN_INTEGRATION_TESTS=1 uv run pytest kxta/test_kxta/test_generate_summary.py
